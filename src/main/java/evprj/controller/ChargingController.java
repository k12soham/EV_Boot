...
public class ChargingController {
	...
	public ResponseEntity<?> remoteStartTransaction(@RequestBody OCPPMessage ocppMessage) {
		...
		// For example, sending a response or performing some actions based on the
		// message
		...
		// Note: The return type is void in this example since we're not sending any
		// response back.
	...
	public void remoteStopTransaction(@RequestBody OCPPMessage ocppMessage) {
		...
		// You can deserialize the JSON payload into your OCPP message model and handle
		// the request here
	}
